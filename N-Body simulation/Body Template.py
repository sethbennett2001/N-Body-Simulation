...
Also if you want to add a custom body you can just set the initial conditions of the class to whatever you would like.
'''
'''
...
'''
SAVE THE FILE as a new .py in the Body_List Folder not overriding the template file save as The name of Body Then Go to the bodies.py file and add the body to the Bodies list as instructed.
'''